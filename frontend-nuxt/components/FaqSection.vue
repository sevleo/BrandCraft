...
=======
<section aria-labelledby="faq" class="w-full mt-[150px] mb-[100px]">
  <h2 class="text-center text-[32px] font-bold tracking-tight text-gray-900 mb-4">
    Frequently Asked Questions
  </h2>
  ...
  <div class="max-w-[800px] mx-auto space-y-4">
    ...
    >
      ...
      >
        <h3 class="text-[17px] font-semibold text-gray-900 group-hover:text-emerald-600 transition-colors duration-200">
          {{ ['Is it really free?', 
              'What platforms does BrandCraft support?',
              'Is there a limit to how many posts I can schedule?',
              'Can I manage multiple accounts?',
              'How far in advance can I schedule posts?'][index] }}
        </h3>
        <ChevronDown
      ...
      <div
        ...
        :class="openQuestions.includes(question) ? 'max-h-[300px] pb-6' : 'max-h-0'"
      >
        <div class="px-6">
          <p class="text-gray-600 text-[15px] leading-relaxed">
            <span v-if="question === 4">
              Yes! It's totally free. You can use all functionality without limitations. At some point however we will add paid plans for extra features: AI Assistance and Video Editing.
            </span>
            <span v-if="question === 0">
              BrandCraft supports all major social media platforms including Instagram, TikTok, YouTube, Facebook, Threads, Bluesky, X (Twitter), and Mastodon. We're constantly adding support for new platforms. To request a specific platform be added, please send an email to 
              <a href="mailto:support@brandcraft.com" class="text-emerald-600 hover:text-emerald-700 font-medium">sev@brandcraft.com</a>, or
              <a href="https://insigh.to/b/brandcraftart" class="text-emerald-600 hover:text-emerald-700 font-medium">request a feature here</a>.
            </span>
            <span v-if="question === 1">
              No, there's no limit to the number of posts you can schedule. Our platform is designed to handle your content needs, whether you're posting once a day or multiple times across different platforms.
            </span>
            <span v-if="question === 2">
              Yes! You can manage multiple accounts across different platforms from a single dashboard. This makes it easy to maintain consistent branding and messaging across all your social media presence.
            </span>
            <span v-if="question === 3">
              You can schedule posts as far in advance as you'd like. Many of our users plan their content weeks or months ahead to maintain a consistent posting schedule.
            </span>
